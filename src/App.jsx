...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-300 via-slate-950 to-slate-300">
      {/* Barra superior */}
      <header className="border-b border-slate-800 bg-slate-950/60 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-2xl bg-black-700 flex items-center justify-center text-white text-lg font-bold shadow-md">
              A
            </div>
            <div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 md:py-10 pb-14">
        <div className="grid gap-8 md:grid-cols-[1.6fr,1fr] items-start">
          ...
          <aside className="space-y-4 md:space-y-5">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-gray-500 to-gray-900 text-white p-6 shadow-xl flex flex-col justify-between min-h-[220px]">
              <div>
            ...
            <div className="rounded-2xl bg-gray-900 border border-gray-700 p-4 text-gray-100 shadow-sm">
              ...
              <p className="text-xs text-slate-400 mt-3">
                “No controlás lo que pasa, pero sí cómo respondés.
                La vida te va a poner pruebas, y muchas no van a ser justas… pero tu poder está en mantener la calma, actuar con propósito y seguir firme sin perder tu esencia.
                Cada día que elegís disciplina sobre excusas, te estás haciendo más fuerte.
                  Y acordate: quien domina su mente, domina su destino.”
              </p>
            </div>
          </aside>
        </div>
